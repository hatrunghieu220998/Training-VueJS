<template>
  ...
  <button @click="onTransitionGroup">Transition Group</button>
</template>
...
export default {
  ...
  methods: {
    onComputed() {
      this.$emit("onComputed");
    },
    onHandlingEvents() {
      this.$emit("onHandlingEvents");
    },
    onRefsTemplate() {
      this.$emit("onRefsTemplate");
    },
    onEvents() {
      this.$emit("onEvents");
    },
    onTransitionGroup() {
      this.$emit("onTransitionGroup");
    },
  },
};
</script>
